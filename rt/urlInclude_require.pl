...
################################################################################
#
# urlInclude_require.pl
#
#   written:  13 Feb 2004 by Peter Mahnke based on urlIncl.cgi
#   modified:
#
#   DESCRIPTION
#   a script that grabs a known content chunk from gartner.com
#   and translates it and saves it to disk
#
#   INPUT
#   ?region=(emea|it|de)
#
