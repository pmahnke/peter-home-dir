...
# getNODocument4.pl has a differnt way to handle authors.... than getNODocument.pl
...
#	$price = $_ if (/Price/);
	...
	# GGPROVFOC
	$provfoc = $1 if (/<META NAME\=\"GGPROVFOC\" CONTENT=\"(.[^\"\>]*)\"\>/i);
...
#		print "\n\nFOUND MULTI LINE AUTHOR LINK $1\n\n";
    ...
    return ($title, $pubDate, $summary, $resId, $auth, $body, $noteNumber, $toc, $price, $pages, $docType, $contentType, $folderType, $keywords, $path, $fileName, $fileSize, $geo, $industry, $infoType, $orgInfo, $docCd, $provfoc);
