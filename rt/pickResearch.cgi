...
local $menu =<<EOF;
<p class="footer">menu: edit [<a href="$thisScript?locale=emea&page=update">emea</a> | <a href="$thisScript?locale=it&page=update">it</a> | <a href="pickResearchDEsimple.cgi?locale=de&page=update">de</a>]<p>
...
&getDoc($FORM{'frcode3'}, $FORM{'frhl3'}, $FORM{'fruri3'} ); # if ($FORM{'frhl3'});
...
&getDoc($FORM{'frcode4'}, $FORM{'frhl4'}, $FORM{'fruri4'} ); # if ($FORM{'frhl4'});
...
sub getDoc {
	...
	# check german db if locale is de and resid starts with 9
	if ($FORM{'locale'} eq "de" && $_[0] =~ /^9/) {
		...
		if ($match) {
			...
			# my $converted = $converter->convert($match);
			...
			$resId   = $meta{'GGRESID'};
			$title   = $meta{'TITLE'};
			$link    = "/regionalization/code/document.jsp?resId=".$meta{'GGRESID'}."&amp;ct=de&amp;gen=y";
			$pubDate = $meta{'LOCALEPUBDATE'};
			$summary = $meta{'GGSUMMARY'};
			$auth    = $meta{'AUTHOR'};

			$msg .= "found german doc in metafile: $resId<br />\n";
		}
...
\n<!--start research  - $origTitle NN:$noteNumber ID:$_[0] DATE:$pubDate  -->
    ...
    <tr><td width="22" bgcolor="#FFFFFF" valign="top" align="center"><a href="$docCode" onclick="openResult('$docCode');return false;" class="smallBlueLink"><img src="//img/homepage/reversed_blue_arrow.gif" width="9" height="9" vspace="2" alt="$title" border="0"></a></td>\n        <td width="328" valign="top" bgcolor="#FFFFFF"><a href="$docCode" onclick="openResult('$docCode');return false;" class="smallBlueLink">$noHangTitle</a></td>\n        <td width="6" bgcolor="#FFFFFF"><img src="/images/trans_pixel.gif" width="6" height="1" alt="" border="0"></td>\n    </tr>
...
\n<!--start news - $origTitle NN:$noteNumber ID:$_[0] DATE:$pubDate -->
    ...
    <tr><td width="22" bgcolor="#FFFFFF" valign="top" align="center"><a href="$docCode" onclick="openResult('$docCode');return false;" class="largeGrayLink"><img src="/images/homepage/reversed_green_arrow.gif" width="9" height="9" vspace="3" alt="$title" border="0"></a></td>\n        <td width="328" valign="top" bgcolor="#FFFFFF"><a href="$docCode" onclick="openResult('$docCode');return false;" class="smallBlueLink" target="_new">$noHangTitle</a></td>\n        <td width="6" bgcolor="#FFFFFF"><img src="/images/trans_pixel.gif" width="6" height="1" alt="" border="0"></td>\n    </tr>
...
EndofHTML
 ...
 <li> <a href="$docCode" onclick="openResult('$docCode'); return false;">$title</a></li>
EndofHTML

    $view .=  <<EndofHTML;
 <li> <a href="http://www4.gartner.com/$docCode" onclick="openResult('http://www4.gartner.com$docCode'); return false;">$title</a></li>
EndofHTML
...
EndofText
	...
	# file to use
	local $fileDir = "/home/gartner/html/rt/content/";

	if ($FORM{'locale'} eq "emea") {
		$fileDir = "$fileDir"."emea/";
	} else {
		$fileDir = "$fileDir"."emea/"."$FORM{'locale'}"."/";
	}

	# save HTML fp
	local $fileFP = "$fileDir"."home_fr_highlight_01.incl";
	open (FP, ">$fileFP") || die "Can't open FP1: $fileFP\n";
	print FP <<ENDofHTML;
...
ENDofHTML
	...
	$fileFP = "$fileDir"."home_fr_highlight_02.incl";
	open (FP, ">$fileFP") || die "Can't open FP2: $fileFP\n";
	print FP <<ENDofHTML;
...
<dl>
<dt><a href="/regionalization/content/emea/$FORM{'url1'}"><img src="$FORM{'img1'}" width="100" height="68" alt="$FORM{'title1'}" border="0" align="left" /></a></dt>
<dd><a href="/regionalization/content/emea/$FORM{'url1'}">$FORM{'title1'}</a></dd>
<dd>$FORM{'desc1'}</dd>
</dl>
</div>
ENDofHTML
	...
	<div class="focalpoint">
<dl>
<dt><a href="/regionalization/content/emea/$FORM{'url2'}"><img src="$FORM{'img2'}" width="100" height="68" alt="$FORM{'title2'}" border="0" align="left" /></a></dt>
<dd><a href="/regionalization/content/emea/$FORM{'url2'}">$FORM{'title2'}</a></dd>
<dd>$FORM{'desc2'}</dd>
</dl>
</div>
ENDofHTML
    ...
    print FP <<ENDofHTML;
          <p class="title"><a href="http://europe.gartner.com/regionalization/content/emea/$FORM{'url1'}" target="blank">$FORM{'title1'}</a></p>
          <p class="desc">$FORM{'desc1'}</p>

               </td>
               <td width="100"><a href="http://europe.gartner.com/regionalization/content/emea/$FORM{'url1'}" target="blank" ><img src="http://europe.gartner.com/$FORM{'img1'}"      width="100" height="68" hspace="6" align="left" alt="$FORM{'title1'}" border="0" /></a></td>
...
ENDofHTML
    ...
    print FP <<ENDofHTML;
  $mtt
  http://europe.gartner.com/regionalization/content/emea/$FORM{'url1'}
  $mtd
ENDofHTML
    close (FP);
...
<script type="text/javascript" language="javascript">
    ...
    document.write('<p><a href="/regionalization/content/emea/$url{$key1}"><img src="http://www.gartner.com/$img{$key1}" width="100" height="68" alt="$title{$key1}" border="0" class="inline" align="left" /></p>');
    document.write('<p><a href="/regionalization/content/emea/$url{$key1}">$title{$key1}</a></p>');
...
<script type="text/javascript" language="javascript">
    document.open();
    document.write('<div class="focalpoint">');
    document.write('<p><a href="/regionalization/content/emea/$url{$key2}"><img src="http://www.gartner.com/$img{$key2}" width="100" height="68" alt="$title{$key2}" border="0" class="inline" align="left" /></p>');
    document.write('<p><a href="/regionalization/content/emea/$url{$key2}">$title{$key2}</a></p>');
...
#	if ($FORM{'locale'} eq "emea") {
#		$fileFP = "$fileFP"."fp.csv";
#	} else {
#		$fileFP = "$fileFP"."emea/"."$FORM{'locale'}"."/fp.csv";
#	}

	open (FP, "$fileFP") || die "Can't open FP to read: $fileFP\n";
	while (<FP>) {
...
#	}
	...
	open (FP, ">$fileFP") || die "Can't open FP to write: $fileFP\n";
