...
<div class="focalpoint">
    <p><a href="http://regionals4.gartner.com/regionalization/content/emea/$url{$key}"><img src="http://regionals4.gartner.com/$img{$key}" width="100" height="68" alt="$title{$key}" border="0" align="text-left" hspace="5" /></a></p>
    <a href="http://regionals4.gartner.com/regionalization/content/emea/$url{$key}">$title{$key}</a>
...
ENDofHTML
     ...
     <li>
      <p class="fpTitle"><a href="http://regionals4.gartner.com/regionalization/content/emea/$url{$key}">$title{$key}</a></p>
