...
# pickResearchDE.cgi
#
#   written:  15 Dec 2003 by Peter Mahnke as pickResearch.cgi
...
#              9 Mar 2004 by Peter Mahnke
#              - forked a german version
#
#
...
chop($date);
chop($yyyymmdd);
local $thisScript = "http://intl.gartner.com/rt/pickResearchDE.cgi";
...
<p class="title"><a href="http://europe.gartner.com/$link">$mailingTitle</a></p>
...
<a href="/regionalization/content/emea/$FORM{'url1'}"><img src="$FORM{'img1'}" width="100" height="68" alt="$FORM{'title1'}" border="0" align="left" /></a>
<p><a href="/regionalization/content/emea/$FORM{'url1'}">$FORM{'title1'}</a></p>
<p>$FORM{'desc1'}</p>
</div>
ENDofHTML
    close (FP);
	...
	print FP <<ENDofHTML;
	<div class="focalpoint">
<a href="/regionalization/content/emea/$FORM{'url2'}"><img src="$FORM{'img2'}" width="100" height="68" alt="$FORM{'title2'}" border="0" align="left" /></a>
<p><a href="/regionalization/content/emea/$FORM{'url2'}">$FORM{'title2'}</a></p>
<p>$FORM{'desc2'}</p>
</div>
ENDofHTML
    close (FP);
...
sub readFP {
	...
	local $fileFP = "/home/gartner/html/rt/content/";
