...
#endif
    if (items < 1 || items > 2)
       croak_xs_usage(cv,  "mode, file=STDIN");
    {
...
#endif
    if (items < 4 || items > 5)
       croak_xs_usage(cv,  "width, height, xpix, ypix, file=STDIN");
    {
