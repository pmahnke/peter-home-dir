...
#line 1 "lib/Params/Validate/XS.xs"
...
#line 1491 "lib/Params/Validate/XS.c"
...
#line 1543 "lib/Params/Validate/XS.c"

XS(XS_Params__Validate__XS_validate); /* prototype to pass -Wmissing-prototypes */
XS(XS_Params__Validate__XS_validate)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 2)
       croak_xs_usage(cv,  "p, specs");
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	SV*	p = ST(0);
	SV*	specs = ST(1);
#line 1492 "lib/Params/Validate/XS.xs"
    HV* ret = NULL;
    AV* pa;
    HV* ph;
    HV* options;
    ...
    RETURN_HASH(ret);
#line 1610 "lib/Params/Validate/XS.c"
	PUTBACK;
	return;
    }
}
...
XS(XS_Params__Validate__XS_validate_pos); /* prototype to pass -Wmissing-prototypes */
XS(XS_Params__Validate__XS_validate_pos)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	SV*	p = ST(0);
#line 1550 "lib/Params/Validate/XS.xs"
    AV* specs;
    AV* ret = NULL;
    IV i;
    ...
    RETURN_ARRAY(ret);
#line 1668 "lib/Params/Validate/XS.c"
	PUTBACK;
	return;
    }
}
...
XS(XS_Params__Validate__XS_validate_with); /* prototype to pass -Wmissing-prototypes */
XS(XS_Params__Validate__XS_validate_with)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    SP -= items;
    {
#line 1592 "lib/Params/Validate/XS.xs"
    HV* p;
    SV* params;
    SV* spec;
    IV i;
...
#line 1790 "lib/Params/Validate/XS.c"
	PUTBACK;
	return;
    }
}
...
extern "C"
#endif
XS(boot_Params__Validate__XS); /* prototype to pass -Wmissing-prototypes */
XS(boot_Params__Validate__XS)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        (void)newXSproto_portable("Params::Validate::XS::validate", XS_Params__Validate__XS_validate, file, "\\@$");
        (void)newXSproto_portable("Params::Validate::XS::validate_pos", XS_Params__Validate__XS_validate_pos, file, "\\@@");
        newXS("Params::Validate::XS::validate_with", XS_Params__Validate__XS_validate_with, file);
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
